...
import { Github, Chrome, ShieldCheck, Sparkles, Rocket, Code2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-background font-outfit">
      ...
      <div className="container relative z-10 flex flex-col lg:flex-row items-center justify-center gap-16 px-4 py-12">
        {/* Right Side: Login Card (Moved to left for variety) */}
        <motion.div
        ...
        >
          <Card className="glass-card border-none bg-background/40 backdrop-blur-3xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] rounded-[48px] overflow-hidden p-2">
            ...
            <CardHeader className="pt-12 pb-8 px-8 text-center">
              ...
              <CardTitle className="text-3xl font-black tracking-tight mb-3">Join the Community</CardTitle>
              <CardDescription className="text-base font-medium">
                Create your account and start sharing your technical journey.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="px-8 space-y-4">
              ...
              <div className="relative py-8">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-[0.2em] font-bold">
                  <span className="bg-transparent px-4 text-muted-foreground">Quick Access</span>
                </div>
              </div>

              <div className="p-6 rounded-[32px] bg-primary/5 border border-primary/10 text-center">
                <p className="text-sm font-medium text-muted-foreground leading-relaxed">
                  By joining, you agree to our <Link href="#" className="underline hover:text-primary transition-colors">Terms of Service</Link> and <Link href="#" className="underline hover:text-primary transition-colors">privacy policy</Link>.
                </p>
              </div>
            </CardContent>
            ...
            <CardFooter className="pb-12 pt-4 px-8 flex justify-center">
                <p className="text-sm font-bold text-muted-foreground">
                    Already have an account? <Link href="/login" className="text-primary hover:underline italic">Sign In</Link>
                </p>
            </CardFooter>
          </Card>
        </motion.div>
        ...
        <div className="flex-1 max-w-xl text-center lg:text-left space-y-8 hidden lg:block">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-black tracking-tight leading-[1.1]">
              Start Your <span className="gradient-text">Mastery</span> Today.
            </h1>
            <p className="text-xl text-muted-foreground font-medium leading-relaxed">
              Create, share, and connect. The most advanced writing platform for technical experts.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: Rocket, title: "Instant Publish", desc: "No manual formatting" },
              { icon: Sparkles, title: "Premium UI", desc: "Glassmorphic perfection" },
              { icon: Code2, title: "Dev Centric", desc: "Built by a developer" },
              { icon: ShieldCheck, title: "Safe & Secure", desc: "Your data is yours" },
            ].map((feature, i) => (
